...
<form id="account-password-form" action="/account/password/post" method="post" class="clear">
  <div class="form-textfield-container clear">
    ...
    <input id="edit-current-password" class="form-textfield form-password" type="password" name="current_password" required maxlength="255" autocomplete="off" pattern="^.{8,}$">
  </div>

  <div class="form-textfield-container clear">
    <label for="edit-new-password"><?php print __('New Password:'); ?> <span class="form-required-marker">*</span></label>
    <input id="edit-new-password" class="form-textfield form-password" type="password" name="user_password" required maxlength="255" autocomplete="off" pattern="^.{8,}$">
  </div>

  <div class="form-textfield-container clear">
    <label for="edit-new-password2"><?php print __('Confirm New Password:'); ?> <span class="form-required-marker">*</span></label>
    <input id="edit-new-password2" class="form-textfield form-password" type="password" name="user_password2" required maxlength="255" autocomplete="off" pattern="^.{8,}$">
  </div>
