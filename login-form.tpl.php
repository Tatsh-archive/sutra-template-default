 ...
 */
?>
<header class="general"><h2><?php print __('Sign in'); ?></h2></header>
<form id="login-form" action="/login/post" method="post">
  ...
  <div class="form-textfield-container">
    <input class="form-password form-textfield" id="edit-password" type="password" name="user_password" value="<?php print fRequest::encode('user_password'); ?>" required placeholder="<?php print __('Password'); ?>" pattern="^.{8,}$">
  </div>
